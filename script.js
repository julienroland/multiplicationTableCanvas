...
(function () {
    ...
    var algorithm = function (n, k) {
        ...
        var red = (yBaseValue * 30 % 255) | 50,
            green = (yBaseValue * 40 % 255) | 150,
        ...
        for (var i = 0; i < n; i++) {
            ...
            //context.lineTo(canvasX / 2  + diameterChange* Math.acosh(k * Math.PI) + Math.PI / i,2 * Math.PI * i);
            //context.lineTo(canvasX / 2 * diameterChange+ Math.log10(k * Math.PI) + Math.PI / i, canvasY / canvasY + 2 * Math.log10(Math.PI * i));
        }
        context.stroke();
    };
